  ...
  return (
    <div className="bg-white h-full overflow-y-scroll">
      <div className="mt-4 flex items-center gap-3 px-5">
        ...
        <div>
          <p>My Status</p>
          <p className="text-xs text-gray-500">Add to my status</p>
        </div>
      </div>
      <div className="flex gap-1 items-center justify-center text-sm text-gray-500 mt-10">
        ...
        <span>Your status uspandates are</span>
        <span className="text-[#027eb5]">end-to-end-encrypted</span>
      </div>
    </div>
  );
};
