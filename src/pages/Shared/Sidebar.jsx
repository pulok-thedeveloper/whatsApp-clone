...
import LeftSlidingBar from "./LeftSlidingBar/LeftSlidingBar";
import toast from "react-hot-toast";

const Sidebar = () => {
  const { imageUrl, setLeftSideBarHead, setIsLeftSideBar, logOut } =
    useContext(AuthContext);
  const [isMenu, setIsMenu] = useState(false);

  return (
    <div className="h-screen relative w-2/5 lg:w-[30%] border-r border-[#E9EDEF] flex flex-col">
      <div className="px-4 py-[10px] flex justify-between">
        <div
          onClick={() => {
            setLeftSideBarHead("Profile");
        ...
        <div className="flex items-center text-[#54656f] gap-7">
          <div
            onClick={() => {
              setLeftSideBarHead("Communities");
              setIsLeftSideBar(true);
            }}
            className="community cursor-pointer"
          >
            <svg
              viewBox="0 0 24 24"
              height="24"
          ...
          <div
            onClick={() => {
              setLeftSideBarHead("Newsletter");
              setIsLeftSideBar(true);
            }}
            className="newsletter cursor-pointer"
          >
            <svg
              viewBox="0 0 24 24"
              height="24"
          ...
          <div
            ...
            className="new-chat cursor-pointer"
          >
            <svg
              viewBox="0 0 24 24"
              height="24"
          ...
          <div
            ...
            className={`menu cursor-pointer relative rounded-full p-1 ${
              isMenu && "bg-[rgba(0,0,0,0.1)]"
            }`}
          >
            <svg
              viewBox="0 0 24 24"
            ...
            <div
              className={`absolute bg-white text-[#3b4a54] py-2 rounded shadow-md right-full top-10 origin-top-right transition-transform duration-300 ${
                isMenu ? "scale-100" : "scale-0"
              }`}
            >
              <ul>
                <li className="pl-6 pr-12 py-2 hover:bg-[#eae6df] transition-all whitespace-nowrap">
                  New group
                </li>
                <li className="pl-6 pr-12 py-2 hover:bg-[#eae6df] transition-all whitespace-nowrap">
                  New community
                ...
                <li
                  onClick={logOut}
                  className="pl-6 pr-12 py-2 hover:bg-[#eae6df] transition-all whitespace-nowrap"
                >
                  Log out
                </li>
              </ul>
      ...
      <div className="bg-white border-b border-[#E9EDEF] px-3 py-2 gap-3 flex items-center">
        <div className="bg-[#F0F2F5] rounded-md flex items-center gap-4 py-[6px] flex-grow">
          ...
          <div className="flex-grow">
            <input
              className="w-full pr-3 bg-transparent outline-none border-none text-sm"
              type="text"
